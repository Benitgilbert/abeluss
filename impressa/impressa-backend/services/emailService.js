        ...
        <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.06); border: 1px solid #f1f5f9;">
            ...
            <div style="padding: 40px 30px;">
                ...
                <div style="text-align: center; margin-top: 40px;">
                    <a href="https://impressa.vercel.app/orders/${order.publicId}" style="display: inline-block; background-color: #6366f1; color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 12px; font-weight: 700; font-size: 16px; transition: background-color 0.2s;">
                        Track My Order
                    </a>
                </div>
            </div>
            ...
            <div style="background-color: #f8fafc; padding: 30px; text-align: center; border-top: 1px solid #e2e8f0;">
                <p style="color: #94a3b8; font-size: 12px; margin: 0;">
                    &copy; ${new Date().getFullYear()} Impressa Marketplace. All rights reserved.
                </p>
                <div style="margin-top: 16px;">
                    <a href="https://impressa.vercel.app" style="color: #6366f1; font-size: 12px; text-decoration: none; margin: 0 8px;">Website</a>
...
export const sendGiftCardEmail = async (giftCard, senderName) => {
    try {
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 20px; padding: 40px; text-align: center; background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%); color: white;">
            ...
            <a href="https://impressa.vercel.app/shop" style="display: inline-block; background: white; color: #6366f1; text-decoration: none; padding: 15px 40px; border-radius: 12px; font-weight: bold; font-size: 16px; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">Shop Now</a>
