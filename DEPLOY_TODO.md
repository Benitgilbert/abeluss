...
4.  Find your repository (`abelus`) and click **"Import"**.

## Step 2: Configure Project settings
In the "Configure Project" screen:
1.  **Framework Preset**: It should auto-detect **Create React App**. If not, select it.
2.  **Root Directory**: Click "Edit" and select `abelus-frontend`. (This is crucial because your repo has both backend and frontend folders).
...
| Key | Value | Example |
| :--- | :--- | :--- |
| `REACT_APP_API_URL` | **Your Render Backend URL** | `https://abelus-api.onrender.com/api` |
...
3.  Once done, you will get a live URL (e.g., `https://abelus-frontend.vercel.app`).
...
3.  Update the `CORS_ORIGIN` or `ALLOWED_ORIGINS` environment variable to include your new Vercel URL (with no trailing slash).
    *   Example: `http://localhost:3000,https://abelus-frontend.vercel.app`
